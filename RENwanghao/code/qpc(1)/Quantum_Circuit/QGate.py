...
def get_E0(i, n):  # act on ith qubit in n qubit
    E0 = np.array([[1.0]])
...
def getX(i, n):
    ...
    while counter <= n:
        if counter == i:
            xgate = np.kron(xgate, X)
        else:
            xgate = np.kron(xgate, I)
        counter += 1
    return xgate
...
def getY(i, n):
    ...
    while counter <= n:
        if counter == i:
            ygate = np.kron(ygate, Y)
        else:
            ygate = np.kron(ygate, I)
        counter += 1
    return ygate
...
def getZ(i, n):
    ...
    while counter <= n:
        if counter == i:
            zgate = np.kron(zgate, Z)
        else:
            zgate = np.kron(zgate, I)
        counter += 1
    return zgate
